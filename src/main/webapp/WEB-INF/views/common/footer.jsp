...
<footer>
	...
	<!-- <div id="BottomWrapper" class="sect-ad">
		<iframe src="./영화 그 이상의 감동. CGV_files/main@Bottom.html" width="100%"
			height="240" title="" frameborder="0" scrolling="no" marginwidth="0"
			marginheight="0" name="Bottom" id="Bottom"></iframe>
	</div>  -->
	...
	<ul class="policy_list">
		...
		<li><a href="https://www.cgv.co.kr/company/cyberAudit.aspx"
	...
	<dl class="company_info_list">
		...
		<dt>통신판매업신고번호</dt>
		<dd>
			2017-서울용산-0662 <a href="https://www.cgv.co.kr/#none"
				onclick="goFtc()" class="btn_goFtc">사업자정보확인</a><a></a>
		</dd>
	</dl>
	<dl class="company_info_list">
		<dt>호스팅사업자</dt>
