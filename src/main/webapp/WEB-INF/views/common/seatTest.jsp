...
<head>
    ...
    <script src="${path }/resources/js/main/seatTest.js"></script>
    <script>
        ...
        <div>
            <form action="example.html" method="get">
                <div id="cinema" class="cinema-wrap" data-name="seat">
                    <div class="cinema-seat-area" data-rowsize="3" data-colsize="5" data-mode="manager" data-fill="auto" data-seatno="visible"></div>
                </div>
