            ...
            <table>
              ...
              <tbody>
                <tr>
                  ...
                  <td><input type="password" name="password" placeholder="password 를 입력하세요."></td>
                </tr>
                <tr>
                  <th><span>닉네임</span></th>
                  <td><input type="text" name="nickname" placeholder="최대 한글 8글자 영문 16글자"></td>
                </tr>
                <tr>
                  <th><span>생년월일</span></th>
                  <td><input type="text" name="date_birth" placeholder="생일을 입력해주세요.ex)2020.01.01"></td>
                </tr>
                <tr>
                  <th><span>주소</span></th>
                  <td><input type="text" name="location" placeholder="주소을 입력해주세요.ex)서울특별시 oo구 "></td>
                </tr>
                <tr>
                  <th><span>성별</span></th>
                ...
                <tr>
                  <th><span>질문</span></th>
                  <td><input type="text" name="question" placeholder="질문을 입력해주세요.ex)가장 좋아하는 색상은?"></td>
                </tr>
                <tr>
                  <th><span>답</span></th>
                  <td><input type="text" name="answer" placeholder="답을 입력해주세요.ex)파랑"></td>
                </tr>
                <tr class="email">
                  <th><span>이메일</span></th>
                  <td>
                ...
                <tr>
                  ...
                  <td><input type="text" name="phone_number" placeholder="휴대폰 번호를 입력하세요."></td>
                </tr>
              </tbody>
            </table>
