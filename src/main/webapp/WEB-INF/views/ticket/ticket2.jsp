			...
			<div id="sec">
				<div id="secMain">
					<div class="row" id="secSelect">
					    ...
					    <div class="row justify-content-around movie" id="MovieTab" role="tablist">
					  ...
					  <!-- 지역 -->
					  <div class="list-group area-category" id="locTap" role="tablist">
					    <div class="row justify-content-around movie-area"> <!-- 이거 추가하면 검은색으로 바뀜 -->
